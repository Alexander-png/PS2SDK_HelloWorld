...
// /* Maximum file size loaded into EE RAM. PS2 has 32 MB total; 8 MB
//  * leaves headroom for framebuffer, libmpeg's working set, and the
//  * decoder's reference frames. Streams larger than this are truncated
//  * (a warning is logged). */
// #define MPEG_PLAYER_MAX_FILE_SIZE   (8 * 1024 * 1024)
