...
EE_STATIC_SRCS = $(SRC_DIR)/main.c \
                 ...
                 $(SRC_DIR)/engine/audio/audio_wav.c \
                 $(SRC_DIR)/engine/audio/audio_voice.c \
                 $(SRC_DIR)/engine/audio/audio_mixer_ps2.c \
                 $(SRC_DIR)/engine/audio/audio_sfx_bank.c \
                 ...
                 $(SRC_DIR)/engine/text/text_rich.c \
                 $(SRC_DIR)/engine/text/text_rich_layout.c \
                 $(SRC_DIR)/engine/debug/screen_console_ps2.c \
                 $(SRC_DIR)/engine/debug/debug_overlay.c \
